    ...
    return (
        <div className="flex-1 bg-transparent dark:bg-slate-900 text-slate-800 dark:text-slate-100 p-6 md:p-10 overflow-y-auto font-sans">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                {/* Form column */}
                <div className="lg:col-span-7 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl p-6 shadow-lg transition-shadow">
                    <form onSubmit={handleSendCampaign} className="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                className="w-full h-64 bg-transparent dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-xl p-3 outline-none text-slate-800 dark:text-slate-200 placeholder-slate-400 dark:placeholder-slate-505 text-sm focus:border-violet-500 focus:ring-2 focus:ring-violet-500/20 transition-all resize-none shadow-lg"
                                required
                            />
                        </div>
                ...
                <div className="lg:col-span-5 space-y-6">
                    <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl p-6 shadow-lg transition-shadow">
                        <h3 className="text-sm font-bold text-slate-700 dark:text-slate-200 border-b border-slate-200 dark:border-slate-700 pb-3 mb-6">Delivery Statistics</h3>
                        <div className="space-y-4">
                            {[
                                ...
                                <div key={i} className="flex justify-between items-center py-2 border-b border-slate-200 dark:border-slate-700/50 last:border-0">
                    ...
                    <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl p-6 shadow-lg transition-shadow">
                        <h3 className="text-sm font-bold text-slate-700 dark:text-slate-200 border-b border-slate-200 dark:border-slate-700 pb-3 mb-4">Historical Campaigns</h3>
                        <div className="space-y-4">
                            {[
                                ...
                                <div key={i} className="pb-3 border-b border-slate-200 dark:border-slate-700/50 last:border-0 last:pb-0">
