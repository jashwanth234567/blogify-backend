        ...
        <div className="flex-1 bg-transparent dark:bg-slate-900 text-slate-800 dark:text-slate-100 p-6 md:p-10 overflow-y-auto font-sans">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                ...
                <div className="lg:col-span-8 space-y-6">
                    <h2 className="text-lg font-bold text-slate-800 dark:text-slate-200 border-b border-slate-200 dark:border-slate-800 pb-3 flex items-center gap-2">
                        <span>🔥</span> Latest AI Industry News
                    </h2>
                    <div className="space-y-4">
                        {aiNews.map((news, i) => (
                            <div key={i} className="p-6 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl shadow-lg transition-shadow hover:border-violet-300 dark:hover:border-slate-600 hover:shadow-lg duration-200">
                ...
                <div className="lg:col-span-4 space-y-6">
                    <div>
                        <h2 className="text-lg font-bold text-slate-800 dark:text-slate-200 border-b border-slate-200 dark:border-slate-800 pb-3 mb-4 flex items-center gap-2">
                            <span>🚀</span> Trending AI Tools
                        </h2>
                        <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl p-4 space-y-3 shadow-lg transition-shadow">
                            {aiTools.map((tool, i) => (
                                <div key={i} className="p-3 bg-transparent dark:bg-slate-900 border border-slate-200 dark:border-slate-700/50 rounded-xl hover:border-violet-300 dark:hover:border-slate-600 transition-all duration-200 shadow-lg">
                                    <div className="flex justify-between items-center mb-1">
                                        <h4 className="text-xs font-bold text-slate-700 dark:text-slate-200">{tool.name}</h4>
                                        <span className="text-[9px] px-2 py-0.5 rounded bg-slate-100 dark:bg-slate-800 text-slate-500 dark:text-slate-400 border border-slate-200 dark:border-slate-700">{tool.cost}</span>
                                    </div>
                    ...
                    <div>
                        ...
                        <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl p-5 space-y-4 shadow-lg transition-shadow">
                            {[
                                ...
                                <div key={i} className="space-y-1 pb-3 border-b border-slate-200 dark:border-slate-700/50 last:border-0 last:pb-0">
